...
public class GraficoPizza extends JPanel {
    private Map<CategoriaGasto, Double> dados;
    ...
    public void atualizarDados(Map<CategoriaGasto, Double> novosDados, double total) {
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (Map.Entry<CategoriaGasto, Double> entry : dados.entrySet()) {
